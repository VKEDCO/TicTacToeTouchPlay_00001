...
class TicTacToeGameBoard {
	...
	TicTacToeGameBoard(short tlx, short tly, short cell_dim) {
		mTLX = tlx; 
		mTLY = tly;
		mCellDim = cell_dim; 
		mBRX = tlx;
	...
	final short getTLX() { return mTLX; }
	final short getTLY() { return mTLY; }
	...
	final short getTRY() { return mTLY; }
	
	final short getBLX() { return mTLX; }
	...
	final short getBRX() { return mBRX; }
	final short getBRY() { return mBRY; }
	
	final short getCellDim() { return mCellDim; }
